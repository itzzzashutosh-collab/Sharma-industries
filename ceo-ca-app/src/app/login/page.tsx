        ...
        <div className="bg-white/80 backdrop-blur-xl border border-white/60 rounded-[32px] p-8 md:p-10 shadow-[0_20px_50px_rgba(139,92,246,0.05)] transition-all hover:shadow-[0_25px_60px_rgba(139,92,246,0.08)]">
          ...
          <div className="mt-8 pt-6 border-t border-slate-100">
            <p className="text-[10px] text-slate-400 mb-4 text-center uppercase tracking-widest font-black">
              Executive Credentials Sandbox
            </p>
            <div className="grid grid-cols-2 gap-3">
              <form action={formAction}>
                <input type="hidden" name="phone" value="9999999999" />
                <input type="hidden" name="password" value="admin123" />
                <button type="submit" disabled={isPending} className="w-full py-3 bg-violet-50 hover:bg-violet-100 text-violet-700 text-xs font-bold rounded-xl border border-violet-200 transition-all cursor-pointer shadow-sm">
                  👑 CEO Office
                </button>
              </form>
              <form action={formAction}>
                ...
                <input type="hidden" name="password" value="admin123" />
                <button type="submit" disabled={isPending} className="w-full py-3 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-xs font-bold rounded-xl border border-indigo-200 transition-all cursor-pointer shadow-sm">
                  📊 Auditor (CA)
                </button>
              </form>
            </div>
