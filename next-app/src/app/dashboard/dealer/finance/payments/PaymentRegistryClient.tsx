...
export function PaymentRegistryClient({ initialData }: { initialData: any[] }) {
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      <div>
        <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest flex items-center gap-1.5 mb-1">
          <span>Dealer Workspace</span><span className="opacity-40">/</span><span>finance</span><span className="opacity-40">/</span><span className="text-foreground">Payment Registry</span>
        </div>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black text-foreground">Payment Registry</h1>
      ...
      <div className="bg-card border border-primary/20 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div className="text-xs text-muted-foreground">
          <span className="font-bold text-foreground">AI Insight:</span> Dynamic overview of active payment registry configurations.
        </div>
      </div>
