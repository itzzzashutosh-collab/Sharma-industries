...
export function StockRegisterClient({ initialData }: { initialData: any[] }) {
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      ...
      <div className="bg-card border border-primary/20 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div className="text-xs text-muted-foreground">
          <span className="font-bold text-foreground">AI Insight:</span> Dynamic overview of active stock register configurations.
        </div>
      </div>
